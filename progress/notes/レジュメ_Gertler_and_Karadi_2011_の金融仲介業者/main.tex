...
金融仲介業者は貸出を行うが，貸出金（資産）$Q_t S_{jt}$のうちすぐに回収できる割合$\lambda$が金融仲介業者の価値（期待生涯資本の合計）よりも大きい場合，金融仲介業者は倒産した方が儲かる．

これを防ぐために，以下の誘因両立制約（Incentive constraint）を導入する．
\begin{equation}
...
\eqref{eq:9}式を\eqref{eq:10}式に代入すると，誘引両立制約
\begin{equation}

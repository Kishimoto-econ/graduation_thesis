...
for v = 1:length(var_list)
    ...
    grid on
    hold off
    cd C:\Users\Kohsu\OneDrive\Desktop\graduation_thesis\code\osr\comparing_parameter_values\output\gamma_q_sweep
    saveas(gcf,[num2str(var_list{v}),'_gamma_q_sweep.png'])
